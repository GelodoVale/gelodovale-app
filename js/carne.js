    ...
    container.innerHTML = entries.map(entry => {
        ...
        <div style="background: rgba(255,255,255,0.02); border: 1px solid ${borderColor}; border-radius: 8px; padding: 10px 12px; display: flex; flex-direction: column; gap: 6px; ${entry.paid ? 'opacity: 0.6;' : ''}">
            ...
            <div style="display: flex; gap: 6px; flex-wrap: wrap; margin-top: 2px;">
                ...
                <a href="${waUrl}" target="_blank" style="flex: 1; min-width: 80px; padding: 5px 8px; background: rgba(37,211,102,0.1); border: 1px solid rgba(37,211,102,0.3); color: #25D366; border-radius: 6px; font-size: 0.75rem; font-weight: 700; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 4px;">
        ...
        <div style="display: flex; align-items: center; gap: 10px; padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.04);">
            ...
            <div style="text-align:right; flex-shrink: 0;">
                ...
                <div style="display: flex; gap: 4px; margin-top: 2px; justify-content: flex-end;">
                    ...
                    ${waPhoneDDI ? `<a href="https://api.whatsapp.com/send?phone=${waPhoneDDI}&text=${waMsg}" target="_blank" style="padding: 2px 6px; font-size: 0.65rem; background: rgba(37,211,102,0.1); border: 1px solid rgba(37,211,102,0.2); color: #25D366; border-radius: 4px; text-decoration: none;">Cobrar</a>` : ''}
                </div>
            </div>
        </div>`;
    }).join('');
